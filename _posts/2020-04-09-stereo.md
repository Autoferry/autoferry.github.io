...
|<img src="{{site.url}}/assets/stereobuilding.png" width="690"> | 
| Stereo imagery with extracted corner features. A calibration board can barely be seen in the lower left corners of the images. | 
